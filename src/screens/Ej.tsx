...
import { StyleSheet, ScrollView, Text, useWindowDimensions, TouchableOpacity, View, ViewBase } from "react-native";
...
const Ej = ({ navigation }: { navigation: any }) => {
  ...
  <ScrollView style={styles.container}>
    ...
    <TouchableOpacity 
      style={[{marginTop: 20, marginBottom: 50}, styles.buttons]}
      onPress={() => {navigation.navigate("Home")}}
    >
